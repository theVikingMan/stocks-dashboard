...
const targetSource = './react-frontend/dist'; // Relative path to copy files from
const targetDestination = './flask-backend/core/static'; // Relative path to copy files to
